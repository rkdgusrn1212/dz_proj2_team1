CREATE TABLE RESTAURANT ( 
  ...
  RESTAURANT_NAME 	VARCHAR2(1024),					-- 식당명
  RESTAURANT_PH 	VARCHAR2(1024),					-- 식당 전화번호
  RESTAURANT_CATEGORY 	VARCHAR2(1024),					-- 식당 분류
  RESTAURANT_MENU 	VARCHAR2(1024),					-- 대표메뉴
  RESTAURANT_SI 		VARCHAR2(1024),					-- 시
  RESTAURANT_GU 	VARCHAR2(1024),					-- 구
  RESTAURANT_DONG 	VARCHAR2(1024),					-- 동
  RESTAURANT_ADDRESS 	VARCHAR2(2048),					-- 도로명 주소
