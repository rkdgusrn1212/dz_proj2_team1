...
public class ValidationProperties {
	public static final String AUTH_PWD_REGEX = "^(?=.*[A-Za-z])(?=.*[0-9])(?=.*[@$!%*#?&^])[A-Za-z0-9@$!%*#?&^]{13,60}$";
	...
	public static final String NAME_REGEX = "^.{2,60}$";
	public static final String NAME_REGEX_DESC = "2자이상 60자 이하의 문자열";
	public static final String AUTH_EMAIL_REGEX = "^[a-zA-Z0-9!#$%&'*+-//=?^_`{|}~_.]+@[a-zA-Z0-9-]+[.]{1}[a-zA-Z0-9-.]+$";
