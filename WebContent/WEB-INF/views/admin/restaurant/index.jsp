...
<body onload="load()">
	...
	<!-- ------------------------maincontainer-------------------------------->
	<div class="container"
		style="float: none; margin: 0 auto; height: 1000px;"
		id="maincontainer">
		<div class="row"
			style="float: none; margin: 0 auto; width: 500px; margin-top: 100px;">
			<div>
				<h1 style="text-align: center; float: left; width: 450;">식당 관리</h1>
				<div style="background-color: #d5d5d5; width: 50px; float: left;">
					<ul class="navbar-nav me-auto">
						<li class="nav-item dropdown" style="margin: 0 auto;"><a
							class="nav-link" id="search-adjust" data-bs-toggle="dropdown"
							aria-haspopup="true" aria-expanded="false"> <img width="30px"
								height="30px" src="${rootPath}/resources/img/search_tune.svg" /></a>
		...
		<div class="col" style="float: none; margin: 0 auto; width: 1250px;"
			id="storeinfo">
			<div class="col"
				style="float: left; margin: 20px; auto; width: 700px;"
				id="storeinfo">
				...
				<div class="col"
					...
					<div class="row"
						...
						<a href="${rootPath}/restaurant/detail"
							style="font-size: 25px; color: orange; text-decoration: none; margin-bottom: 5px; font-weight: bold;"
							id="storetitle0"><b>홍콩반점 1954</b></a>

						<div class="col">
							<div class="row" style="float: left; width: 120px;">
								<span
									style="font-size: 17px; text-decoration: none; text-align: center;"><b>대표메뉴</b></a>
							</div>
							<div class="row" style="float: left; width: 380px;">
								<span
									style="font-size: 17px; text-decoration: none; font-weight: bold;"
									id="mainmenu0"><b>짜장면</b></a>
							</div>
						...
						<div class="col">
							<div class="row" style="float: left; width: 120px;">
								<span
									style="font-size: 17px; text-decoration: none; text-align: center;"><b>주소</b></a>
							</div>
							<div class="row" style="float: left; width: 380px;">
								<span
									style="font-size: 17px; text-decoration: none; font-weight: bold;"
									id="juso0"><b>경기도 부천시 상동</b></a>
							</div>
							<div class="col" style="margin-top: 30px;">
								<div class="row" style="float: left; width: 120px;">
									<span
										style="font-size: 17px; text-decoration: none; font-size: 23px; margin-left: 25px;"><b>평점</b></a>
								</div>
								<div class="row" style="float: left; width: 200px;">
									<span
										style="font-size: 22px; text-decoration: none; text-align: center; color: orange; border: 1px solid; margin-left: 10px;"
										id="avgvalue0"><b>5.0</b></span>
								</div>
								<span class="badge bg-danger"
									name = ""  onclick = "del(this)" style="width: 50px; float: right; margin: 5px;" id="delbtn0">삭제</span>
					...
					<div class="row"
						...
						<div class="col">
							...
							<div class="row" style="float: left; width: 380px;">
								<span
									style="font-size: 17px; text-decoration: none; font-weight: bold;"
									id="juso1">경기도 부천시 상동</a>
							</div>
							<div class="col" style="margin-top: 30px;">
								<div class="row" style="float: left; width: 120px;">
									<span
										style="font-size: 17px; text-decoration: none; font-size: 23px; margin-left: 25px; font-weight: bold;">평점</a>
								</div>
								<div class="row" style="float: left; width: 200px;">
									<span
										style="font-size: 22px; text-decoration: none; text-align: center; color: orange; border: 1px solid; margin-left: 10px; font: bold;"
										id="avgvalue1">5.0</span>
								</div>
								<span class="badge bg-danger"
									name = ""  onclick = "del(this)"  style="width: 50px; float: right; margin: 5px;" id="delbtn1">삭제</span>
							</div>
						...
						<div class="col">
							...
							<div class="col" style="margin-top: 30px;">
								...
								<div class="row" style="float: left; width: 200px;">
									<span
										style="font-size: 22px; text-decoration: none; text-align: center; color: orange; border: 1px solid; margin-left: 10px; font: bold;"
										id="avgvalue2">5.0</span>
								</div>
								<span class="badge bg-danger" name = ""  onclick = "del(this)"
									style="width: 50px; float: right; margin: 5px;" id="delbtn2">삭제</span>
							</div>
						...
						<div class="col">
							...
							<div class="col" style="margin-top: 30px;">
								...
								<div class="row" style="float: left; width: 200px;">
									<span
										style="font-size: 22px; text-decoration: none; text-align: center; color: orange; border: 1px solid; margin-left: 10px; font: bold;"
										id="avgvalue3">5.0</span>
								</div>
								<span class="badge bg-danger" name = ""  onclick = "del(this)"
									style="width: 50px; float: right; margin: 5px;" id="delbtn3">삭제</span>
							</div>
						...
						<div class="col">
							...
							<div class="col" style="margin-top: 30px;">
								...
								<div class="row" style="float: left; width: 200px;">
									<span
										style="font-size: 22px; text-decoration: none; text-align: center; color: orange; border: 1px solid; margin-left: 10px; font: bold;"
										id="avgvalue4">5.0</span>
								</div>
								<span class="badge bg-danger" name = ""  onclick = "del(this)"
									style="width: 50px; float: right; margin: 5px;" id="delbtn4">삭제</span>
							</div>
			...
			<div class="row"
				style="float: left; margin: 20px auto; width: 500px; height: 810px;">
...
<script>
		...
		$.ajax({
			...
			success : function(response) {
				...
				for (idx in response) {
					...
					$('#delbtn' + idx).attr("name", response[idx].restaurantNo);
				}
				setMarkers(map);
				map.relayout();
			}
				...
				.ajax({
					...
					success : function(response) {
						...
						for (idx in response) {
							...
							$('#storetitle' + idx).attr(
									"href",
									"${rootPath}/admin/restaurant/form?id="
											+ response[idx].restaurantNo) // a 태그 href 변경
							$('#mainmenu' + idx).text(
	...
	function del(btn){
		 ...
		 $.ajax({
		        url : "${rootPath}/api/restaurant/"+$(btn).attr('name'),
		        type : "delete",
		        success: (response)=> {
	                alert("삭제 성공","방금",$(btn).attr('name')+"번 식당이 삭제되었습니다");
	                location.reload();

	             },
		        error: (error)=>{
		        	alert("삭제 실패","방금","알수 없는 오류 발생");
		        }
		    });
	}
