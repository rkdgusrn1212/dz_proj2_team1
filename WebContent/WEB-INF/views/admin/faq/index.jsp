...
<body>
    ...
    <div class="container-lg">
        ...
        <h1>FAQ 관리</h1>
        <div class="align-self-end"><small><span class='badge rounded-pill bg-danger'>삭제</span> 버튼을 눌러 해당 FAQ을 삭제합니다.</small>
        </div>
        </div>
        ...
        <div class="row justify-content-md-center">
            <div class="col-auto">
                <ul class="pagination" style="" id="faq-pagination">
                </ul>
            </div>
        </div>
    </div>
