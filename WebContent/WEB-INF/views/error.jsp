...
<head>
<meta charset="utf-8">
<title>Tasty Way : 페이지가 없습니다</title>
...
<body id="t">
	<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
		<div class="onlyforchrome"
			style="font-size: 30px; text-align: center; font-family: Helvetica;">404,
			존재하지 않는 페이지 입니다.</div>
		<div class="onlyforchrome"
		...
		<div id="main-frame-notchrome"
			style="display: none; margin-top: 50px;">
			공룡 게임은 크롬 전용 입니다. 크롬 다운받기 -> <a href="https://www.google.com/chrome">here</a>
		</div>
		<div id="offline-resources" jstcache="0">
			<div id="offline-resources-1x" jstcache="0">
				<img id="1x-obstacle-large"
					...
					jstcache="0"> <img id="1x-obstacle-small"
			...
			<div id="offline-resources-2x" jstcache="0">
				<img id="2x-obstacle-large"
					...
					jstcache="0"> <img id="2x-obstacle-small"
